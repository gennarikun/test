...
( 11, 11, "アクアワールド・大洗","あくあわーるど・おおあらい","日本一のサメの飼育数を誇り、マンボウやラッコなど約580種68000点の世界の海の生物に出会うことができる水族館です。", 3, 2, 1850,"./images","aqua_world_ibaraki.jpg",now(),"公益財団法人いばらき文化振興財団","茨城県東茨城郡大洗町磯浜町8252-3","「大洗駅」よりバス15分","http://www.aquaworld-oarai.com",0,cast('2018-09-01' as date),cast('2018-12-31' as date),now(),now()),
...
( 45, 45, "三鷹の森ジブリ美術館","みたかのもりじぶりびじゅつかん","吉祥寺通り沿いに三鷹の森を歩いていると、やさしい風合いの建物が出現。そばには「三鷹の森ジブリ美術館」の看板が立っています。看板の前に到着すると、おっきなトトロが受付でお出迎え。穴を覗けば、マックロクロスケもいます。", 6, 7,1000,"./images","ghibli_ｍ1.jpg",now(),"公益財団法人徳間記念アニメーション文化財団","東京都三鷹市下連雀1丁目1-83","「三鷹駅」より徒歩15分","http://www.ghibli-museum.jp/",0,cast('2018-01-01' as date),cast('2018-03-31' as date),now(),now()),
